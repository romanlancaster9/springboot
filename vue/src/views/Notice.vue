<template>
  <div>
    <div style="margin: 10px 0">
      <el-input style="width: 200px" placeholder="please input title" suffix-icon="el-icon-search" v-model="name"></el-input>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="user" label="publish user"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="140px" size="small" style="width: 85%;" :model="form" :rules="rules" ref="ruleForm">
        ...
        <el-form-item prop="time" label="publish time">
          <el-date-picker v-model="form.time" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="please select time"></el-date-picker>
        </el-form-item>
        <el-form-item prop="user" label="publish user">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(process.env["VUE_APP_PRE_API"] + "/notice/export")
    },

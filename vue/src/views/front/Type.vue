    ...
    <el-card style="margin: 10px 0">
      <el-table :data="tableData" style="margin: 10px 0">
        ...
        <el-table-column label="operate" width="200" align="center">
          <template slot-scope="scope">
            <el-button type="success" style="background-color: #ffd86b" @click="handleEdit(scope.row)">
              update <i class="el-icon-edit"></i>
            </el-button>
            <el-popconfirm
              class="ml-5"
...
.el-button--success:hover {
  background-color: #e9ba37;
  border-color: #e9ba37;
}
.el-button--danger {
  background: linear-gradient(to right, #f6ab8e, #ef6e46) !important;
  border-color: linear-gradient(to right, #f6ab8e, #ef6e46) !important;
  /* border: 1px solid transparent;
  border-image: linear-gradient(to right, #f6ab8e, #ef6e46) 1; */
}
</style>
